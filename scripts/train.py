...
def train_model(df, N_ESTIMATORS=200, MAX_FEATURES='sqrt', TEST_SIZE=0.3, MAX_DEPTH=10, RANDOM_STATE=42, MIN_SAMPLES_SPLIT=2, BOOTSTRAP=True, MIN_SAMPLES_LEAF=1, show_info=False):
    df = pd.read_csv(df)
    ...
    with mlflow.start_run():
        ...
        dump(model, '/workdir/model/model.joblib')
